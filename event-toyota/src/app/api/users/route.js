...
//         // console.log(searchTerm, '==> apa ini jiah');
...
//         const filteredUsers =  dataUser.find(user => user.title.toLowerCase().includes(searchTerm.toLowerCase()))

//         // console.log(filteredUsers, "=> apaxx");
        
//         return new Response(
//             JSON.stringify({ status: "success", data: filteredUsers }),
...
export async function POST(request) {
    try { // Ambil data JSON dari body request
        console.log(await request.json(), "==> sampai sini pak");
